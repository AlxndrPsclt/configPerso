...
########################################
#Ceci est juste la présentation d'intro#
#           du terminal.               #
########################################
#IPADDR=`ifconfig wlan0 | grep "inet " | cut -d: -f2 | cut -c1-14`

#toilet -f smbraille.tlf 'alex              ' $IPADDR
...
[ -r /home/hujiawei/.byobu/prompt ] && . /home/hujiawei/.byobu/prompt   #byobu-prompt#
